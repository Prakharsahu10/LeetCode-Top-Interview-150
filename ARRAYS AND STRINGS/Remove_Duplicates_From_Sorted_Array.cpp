...
public:
    int removeDuplicates(vector<int> &nums)
    {
        ...
        int i = 0; // Slow pointer - tracks the end of unique elements
...
// We traverse the array once, making it linear in time complexity.
// Space Complexity: O(1), as we are modifying the array in place without using any additional data structures.
// This solution efficiently removes duplicates while maintaining the order of unique elements.
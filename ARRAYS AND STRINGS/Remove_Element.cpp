...
// This is because we traverse the array once to remove elements equal to val.
// Space Complexity: O(1), as we are modifying the array in place without using any
// additional data structures.
// The solution efficiently removes elements equal to val by shifting valid elements to the front of the array